...
class ConnectionHandler(Protocol):
    ...
    def execute(self, query, arguments, sql_parameters=None):
        """ Executes the query. """

    def query(self, query, arguments, sql_parameters=None):
        """
    ...
    def query_single_value(self, query, arguments, sql_parameters=None):
        """
    ...
    def query_list_of_single_values(self, query, arguments, sql_parameters=None):

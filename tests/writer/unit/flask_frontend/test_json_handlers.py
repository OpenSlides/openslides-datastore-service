...
from datastore.shared.util import BadCodingError, InvalidFormat
...
class TestWriteHandler:
    ...
    def test_correct_schema(self, write_handler, writer):
        ...
        with patch("datastore.writer.flask_frontend.json_handlers.WriteRequest") as wr:
            write_handler.write(
                {
                    "user_id": -2,
    ...
    def test_create_create_event(self, write_handler):
        ...
        with patch(
            "datastore.writer.flask_frontend.json_handlers.RequestCreateEvent"
        ) as rce:
    ...
    def test_create_update_event(self, write_handler):
        ...
        with patch(
            "datastore.writer.flask_frontend.json_handlers.RequestUpdateEvent"
        ) as rue:
    ...
    def test_create_delete_event(self, write_handler):
        ...
        with patch(
            "datastore.writer.flask_frontend.json_handlers.RequestDeleteEvent"
        ) as rde:
    ...
    def test_create_restore_event(self, write_handler):
        ...
        with patch(
            "datastore.writer.flask_frontend.json_handlers.RequestRestoreEvent"
        ) as rre:

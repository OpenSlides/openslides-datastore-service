...
from datastore.shared.util import BadCodingError, InvalidFormat, InvalidKeyFormat
...
from datastore.writer.core.write_request import assert_no_special_field
...
def test_assert_no_special_field():
    with patch("datastore.writer.core.write_request.is_reserved_field") as irf:

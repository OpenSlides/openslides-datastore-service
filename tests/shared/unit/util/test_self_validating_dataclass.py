...
from datastore.shared.util import BadCodingError, InvalidFormat, SelfValidatingDataclass
...
def test_optional():
    ...
    with patch("datastore.shared.util.self_validating_dataclass.assert_is_fqid"):

...
export DATASTORE_DATABASE_USER_FILE=${DATASTORE_DATABASE_USER_FILE:-/run/secrets/datastore_postgres_user}
export DATASTORE_DATABASE_PASSWORD_FILE=${DATASTORE_DATABASE_PASSWORD_FILE:-/run/secrets/datastore_postgres_password}

...
export DATASTORE_DATABASE_USER_FILE=${DATASTORE_DATABASE_USER_FILE:-/run/secrets/datastore_database_user_file}
export DATASTORE_DATABASE_PASSWORD_FILE=${DATASTORE_DATABASE_PASSWORD_FILE:-/run/secrets/datastore_database_password_file}
